package com.wsw.fitnesssystem.auth.infrastructure.audit.repository;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.wsw.fitnesssystem.auth.domain.audit.model.LoginAudit;
import com.wsw.fitnesssystem.auth.domain.audit.port.LoginAuditRepository;
import com.wsw.fitnesssystem.auth.infrastructure.audit.persistence.db.converter.LoginAuditConverter;
import com.wsw.fitnesssystem.auth.infrastructure.audit.persistence.db.entity.SysUserLogin;
import com.wsw.fitnesssystem.auth.infrastructure.audit.persistence.db.mapper.SysUserLoginMapper;
